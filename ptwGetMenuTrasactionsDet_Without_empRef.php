...
$vendorSql = "SELECT e.Name as RaiseName, (case when e1.Name is null then e.Name else e1.Name end) as VendorName FROM Employees e left join Employees e1 on e.RMId = e1.EmpId WHERE e.EmpId = '$fillingByEmpId'";
